...
public class ModBlocks {
    ...
    public static final Block CHOPPING_BOARD = register(Names.Block.CHOPPING_BOARD, new ChoppingBoardBlock(Block.Properties.from(Blocks.OAK_PLANKS).hardnessAndResistance(0.5F)));
    public static final Block COMPUTER = register(Names.Block.COMPUTER, new ComputerBlock(Block.Properties.from(Blocks.ANVIL).hardnessAndResistance(1.0F)));
    public static final Block BATH = register(Names.Block.BATH, new BathBlock(Block.Properties.from(Blocks.STONE).hardnessAndResistance(1.0F)));
