 ...
 * Author: MrCrayfish
 */
public class PhotoFrameRenderer extends TileEntityRenderer<PhotoFrameTileEntity>
{
    private static final ResourceLocation NOISE = new ResourceLocation("cfm:textures/noise.png");
    private static final Random RAND = new Random();

    @Override
    public void render(PhotoFrameTileEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha)
    {
        if(te.getPhoto() == null)
            return;
